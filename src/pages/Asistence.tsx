      ...
      <div className="flex justify-between items-center">
        ...
        <AnimatePresence>
          {isModalOpen && (
            // Overlay del modal
            <motion.div
              className={twMerge('fixed min-h-screen overflow-y-auto inset-0  bg-opacity-70 backdrop-blur-sm flex items-start justify-center z-50 p-4')}
            ...
            >
              {/* Contenido del modal */}
              <motion.div
                className={twMerge("bg-white rounded-2xl shadow-2xl p-8 max-w-3xl w-full text-center relative overflow-hidden transform")}
